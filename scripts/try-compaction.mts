...
const allGroups = memory.identifyGroups(60, true);
...
const result = await compressGroups(memory, toCompress, llm, process.env.PROMPTS_DIR as string, process.env.USER_TZ as string);
